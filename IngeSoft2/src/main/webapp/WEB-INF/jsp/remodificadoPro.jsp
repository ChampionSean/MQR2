						...
						<form class="form-horizontal" method="POST" action="/HQR/modificaProyecto">
							<fieldset>
								<!-- Name input-->
									...
									<div class="col-md-9">
									<input id="cli_id" class="form-control" value="${proyecto.id_proyecto}" name="cli_id" type="hidden" placeholder=" cli_id" readonly>
									</div>
								</div>        
						    ...
						    <tr>
						        ...
						        <th data-field="Empresa">Empresa</th>
                                                    ...
                                                    <c:forEach var="empleado" items="${empleados}">
                                                        <tr>
                                                            <td>${empleado.empleado.persona_id.nombre} ${empleado.empleado.persona_id.apellido_paterno}</td>
                                                            <td>${empleado.empleado.puesto}</td>
                                                            <td>${empleado.empleado.nombre_empresa}</td>
                                                             </tr>
                                                          </c:forEach>
						</table>
					</div>
