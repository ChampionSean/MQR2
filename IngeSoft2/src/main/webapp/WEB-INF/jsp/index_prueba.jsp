  ...
  <body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tables</h1>
                                ...
                                <a href="<c:url value="#"/> "><button class="btn-primary">Agregar Prueba</button></a>
      ...
      <tr>
          ...
          <td><a href="<c:url value="/administrador/show_prueba?id=${prueba.id_prueba}" />">${prueba.nombre_prueba}</a></td>
