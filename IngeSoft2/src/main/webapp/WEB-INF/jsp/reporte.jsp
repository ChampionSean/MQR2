<%-- 
    Document   : reporte
    Created on : 22-ene-2017, 15:56:16
    Author     : Marco
--%>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="state" data-sortable="true">Participante</th>
						        ...
						        <th data-field="price" data-sortable="true">No Pregunta</th>
                                                    ...
                                                    <c:forEach var="r" items="${respuestaE}">
      <tr>
  
          <td>${r.empleado.persona_id.nombre} ${r.empleado.persona_id.apellido_paterno}</td>
