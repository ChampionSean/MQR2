<%-- 
    Document   : empleado_prueba
    Created on : 30-nov-2016, 15:06:37
    Author     : Marco
--%>
...
Te pedimos contestar de la manera más honesta y sincera posible ya que no existen respuestas buenas o malas.  
		...
		<br>
		<br>
			    <input id="1" type="radio" name="16" value="6"> 
				<label for="1">-5</label>
				
				<br>
                 <input id="2" type="radio" name="16" value="7"> 
				<label for="2">-6</label>
				
				<br>
                 <input id="3" type="radio" name="16" value="8"> 
				<label for="3">7</label>
				
				<br>
                 <input id="4" type="radio" name="16" value="9"> 
				<label for="4">6</label>
				
				<br>
                 <input id="5" type="radio" name="16" value="10">
				<label for="5">-7</label>
